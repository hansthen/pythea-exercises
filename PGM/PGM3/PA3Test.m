...
for test = 1:6
  ...
  case 4
    ...
    %samples.Part4SampleFactorOutput
    factor = ComputeSimilarityFactor(images, models.imageModel.K, 1, 2);
    ok = checkResult('ComputeSimilarityFactor', samples.Part4SampleFactorOutput, SortFactorVars(factor), factor);
  case 5
  ...
  case 6
    ...
    factors = SortAllFactors(factors);
    samples.Part6SampleFactorsOutput
    factors
