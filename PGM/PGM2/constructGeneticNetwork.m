...
for i=1:numPeople
    ...
    if parent1 == 0
        factor = genotypeGivenAlleleFreqsFactor(alleleFreqs, i);
    else
        factor = genotypeGivenParentsGenotypesFactor(numAlleles, i, parent1, parent2);
    end
    factorList(i) = factor;
end

for i=1:numPeople
    factor = phenotypeGivenGenotypeFactor(alphaList, i, numPeople+i);
    factorList(numPeople + i) = factor;
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
