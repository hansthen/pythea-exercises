...
typedef class SemanticTable * SymTab; // defined in semant.h
...
public:
   ...
   virtual void annotate(SymTab) = 0;
...
class method_class; // forward declaration
class attr_class; // forward declaration
...
public:
   ...
   virtual Class_ get_parent_class() = 0;
   virtual Classes get_parents() = 0;
   virtual void expand_hierarchy(SymTab) = 0;
   virtual void add_parent(SymTab) = 0;
   virtual method_class * get_method(Symbol, SymTab) = 0;
   virtual attr_class * get_attr(Symbol, SymTab) = 0;
   virtual bool is_subtype_of(Class_ c) = 0;
...
public:
   ...
   void dump(ostream& stream, int n);
   virtual void annotate(SymTab);
   virtual void expand_hierarchy(SymTab);
   virtual void add_parent(SymTab);
   virtual Symbol get_name() { return name; };
   virtual Symbol get_parent() { return parent; };
   virtual Class_ get_parent_class() { return parent_class; }
   virtual Classes get_parents() { return parents; }
   virtual method_class * get_method(Symbol, SymTab);
   virtual attr_class * get_attr(Symbol, SymTab);
   virtual bool is_subtype_of(Class_ c);
...
public:
   ...
   virtual bool check_dispatch(Expressions, SymTab);
   virtual bool check_override(Formals, SymTab);
...
public:
   ...
   void dump(ostream& stream, int n);
   virtual void annotate(SymTab);
   virtual Symbol get_type() { return expr->get_type(); };
