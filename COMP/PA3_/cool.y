...
%{
  ...
  #define cool_yylloc curr_lineno  /* use the curr_lineno from the lexer
    ...
    */
    ...
    { yyerrok;}
    | OBJECTID '(' expr_list ')'
    { $$ = dispatch(object(Symbol(idtable.add_string("self"))), $1, $3); }
    | OBJECTID '(' error ')' 
    { yyerrok;}
    ...
    | '{' expr_block '}'
    { $$ = block($2); }
    /* TESTME: let statement should be able to handle multiple assignments */
    | LET let_list
    { $$ = $2; }
    /* TESTME: add error handling to multiple LET statements
